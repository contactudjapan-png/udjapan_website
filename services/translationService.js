...
const SEEDS = [
  ...
  { key: 'event.field_phone',     bn: 'ফোন / WhatsApp নম্বর',                                                                                                                              en: 'Phone / WhatsApp Number',                                                                              de: 'Telefon- / WhatsApp-Nummer' },
  { key: 'event.field_contact',   bn: 'ইমেইল ঠিকানা',                                                                                                                                    en: 'Email Address',                                                                                        de: 'E-Mail-Adresse' },
  { key: 'event.field_contact_ph',bn: 'your@email.com',                                                                                                                                   en: 'your@email.com',                                                                                       de: 'ihre@email.de' },
  { key: 'event.contact_either',  bn: 'ইমেইল অথবা ফোন নম্বর — অন্তত একটি বাধ্যতামূলক',                                                                                                  en: 'Email or phone number — at least one is required',                                                     de: 'E-Mail oder Telefonnummer — mindestens eine Angabe ist erforderlich' },
  { key: 'event.contact_err',     bn: 'ইমেইল অথবা ফোন নম্বর — অন্তত একটি দিতে হবে।',                                                                                                   en: 'Please provide either an email address or a phone number.',                                            de: 'Bitte geben Sie eine E-Mail-Adresse oder eine Telefonnummer an.' },
  { key: 'event.payment_method',  bn: 'কোথায় পেমেন্ট করেছেন?',                                                                                                                         en: 'Where did you pay?',                                                                                   de: 'Wo haben Sie bezahlt?' },
