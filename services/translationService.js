...
const SEEDS = [
  ...
  { key: 'event.privacy_consent', bn: 'নিবন্ধন করার মাধ্যমে আপনি আমাদের', en: 'By registering you accept the', de: 'Mit der Anmeldung akzeptieren Sie die' },
  { key: 'event.privacy_policy',  bn: 'গোপনীয়তা নীতি', en: 'privacy policy', de: 'Datenschutzerklärung' },
